  ...
  return (
    <main className={`${headingFont.variable} ${bodyFont.variable} font-[var(--font-body)]`}>
      ...
      <footer className="relative z-10 border-t border-white/10 bg-black/40 backdrop-blur-md">
        <div className="mx-auto w-full max-w-6xl px-6 py-8 md:px-10 text-center">
          <p className="text-sm text-neutral-500">© {new Date().getFullYear()} MindEase. Designed for student wellness.</p>
        </div>
      </footer>
    </main>
  );
