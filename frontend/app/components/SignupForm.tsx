          ...
          <CardContent>
            <div className="flex flex-col gap-5">
              ...
              <div className="grid gap-2">
                <Label htmlFor="name" className="text-white/80 font-semibold">Name</Label>
                <Input
                  id="name"
                  name="name"
                  type="text"
          ...
          <CardFooter className="flex-col gap-4 pb-8 pt-4">
            ...
            <div className="relative w-full text-center">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-[#0d1a2a] px-2 text-white/50">Or continue with</span>
              </div>
            </div>

            <a href={`${BACKEND_URL}/auth/google`} className="w-full">
              <Button type="button" variant="outline" className="w-full bg-white/5 border-white/10 hover:bg-white/10 text-white rounded-xl h-11 transition-all">
            ...
            <p className="text-center text-sm text-white/60 mt-2">
              ...
              <Link href="/login" className="text-teal-400 hover:text-teal-300 font-semibold underline-offset-4 hover:underline">
                Log in
              </Link>
            </p>
          </CardFooter>
