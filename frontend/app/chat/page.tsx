...
//     console.log(token)
//     // const question = "Hey, tell me about yourself"
//     try {
    ...
    return (
        <div>
            <div className="messages">
                {messages.map((msg, i) => (
                    <div key={i}>
                        <p><strong>You:</strong> {msg.ques}</p>
                        <p><strong>Bot:</strong> {msg.ans}</p>
                    </div>
                ))}
            </div>
            <input 
                value={input}
                onChange={(e) => setInput(e.target.value)}
                placeholder="Ask anything about ymw..."
            />
